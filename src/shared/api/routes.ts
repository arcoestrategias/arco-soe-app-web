...
export const routes = {
  ...
  positions: {
    ...
    toggleActive: (positionId: string) =>
      prefixed(Modules.POSITIONS, positionId, "active"),
  ...
  objectives: {
    ...
    listAllStatus: () => prefixed(Modules.OBJECTIVES, "all-status"),
    ...
    strategyMap: (strategicPlanId: string) =>
